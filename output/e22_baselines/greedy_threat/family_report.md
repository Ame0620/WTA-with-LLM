...
- generated at: 2026-09-08 16:41:27

## Per-instance metrics (mean +- std over 30 MC seeds)

| instance | total value | leak rate | gap mean | invalid | ammo eff | latency p50 (s) | shots | destroyed value | result hash |
|---|---:|---:|---:|---:|---:|---:|---:|---:|---|
| `dn_3x50_K10_s01.txt` | 3942 | 0.8610 | 0.5293 | 0.5444 | 30.2131 | 0.414 | 18.0 | 548.0 | `c7b2126e1dfe` |
| `dn_3x50_K10_s02.txt` | 3819 | 0.8578 | 0.5298 | 0.4463 | 30.0160 | 0.421 | 18.0 | 543.1 | `b396e2bb9a7e` |
...
| latency_p50 | 0.4177 +- 0.0037 [worst 0.4214] | 0.4214 |
| latency_p90 | 0.4878 +- 0.0003 [worst 0.4881] | 0.4881 |
