...
- generated at: 2026-09-23 01:04:08

## Per-instance metrics (mean +- std over 30 MC seeds)

| instance | total value | leak rate | gap mean | invalid | ammo eff | latency p50 (s) | shots | destroyed value | result hash |
|---|---:|---:|---:|---:|---:|---:|---:|---:|---|
| `dn_3x50_K10_s01.txt` | 3942 | 0.6497 | 0.4975 | 0.2118 | 89.4102 | 0.003 | 17.0 | 1380.9 | `436f6f67eb50` |
...
| gap_mean | 0.4313 +- 0.0662 [worst 0.4975] | 0.4975 |
