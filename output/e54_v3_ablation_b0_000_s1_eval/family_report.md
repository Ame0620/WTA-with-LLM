...
- generated at: 2026-09-23 01:03:52

## Per-instance metrics (mean +- std over 30 MC seeds)

| instance | total value | leak rate | gap mean | invalid | ammo eff | latency p50 (s) | shots | destroyed value | result hash |
|---|---:|---:|---:|---:|---:|---:|---:|---:|---|
| `dn_3x50_K10_s01.txt` | 3942 | 0.6591 | 0.5064 | 0.2250 | 93.3864 | 0.003 | 16.0 | 1343.8 | `2d1a082f72d9` |
| `dn_3x50_K10_s02.txt` | 3819 | 0.5669 | 0.3569 | 0.1093 | 90.3440 | 0.003 | 18.0 | 1654.0 | `3def7e601bdd` |
