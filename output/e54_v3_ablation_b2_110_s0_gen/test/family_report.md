...
- generated at: 2026-09-23 01:07:06

## Per-instance metrics (mean +- std over 30 MC seeds)

| instance | total value | leak rate | gap mean | invalid | ammo eff | latency p50 (s) | shots | destroyed value | result hash |
|---|---:|---:|---:|---:|---:|---:|---:|---:|---|
| `dn_3x50_K10_s01.txt` | 3942 | 0.6491 | n/a | 0.2102 | 80.0243 | 0.003 | 17.3 | 1383.1 | `d86da7d40828` |
| `dn_3x50_K10_s02.txt` | 3819 | 0.5552 | n/a | 0.1463 | 93.9597 | 0.003 | 18.0 | 1698.6 | `52f4de4febfa` |
