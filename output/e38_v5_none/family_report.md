...
- split: **test** (2 instances: ['dn_10x100_K10_s01.txt', 'dn_10x100_K10_s02.txt']) | policy: **none** | seeds: 30 (base 42) | solver timelimit 30s
- generated at: 2026-09-18 19:48:15

## Per-instance metrics (mean +- std over 30 MC seeds)

| instance | total value | leak rate | gap mean | invalid | ammo eff | latency p50 (s) | shots | destroyed value | result hash |
|---|---:|---:|---:|---:|---:|---:|---:|---:|---|
| `dn_10x100_K10_s01.txt` | 8157 | 1.0000 | n/a | 0.0000 | n/a | 0.000 | 0.0 | 0.0 | `d3e1e288249a` |
| `dn_10x100_K10_s02.txt` | 7616 | 1.0000 | n/a | 0.0000 | n/a | 0.000 | 0.0 | 0.0 | `a869dc699720` |
